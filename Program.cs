...
namespace adblock
{
    ...
    internal class Program
    {
        ...
        private const double ByteSizeInKiloBytes = 0.0009765625;
        ...
        static void Main()
        {
            try
            {
                ...
                Console.WriteLine($"The server list file is {serverListUrl.Length * ByteSizeInKiloBytes:0.00} kilobytes long.");
